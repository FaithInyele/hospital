...
<div class="panel">
    @if(session('status'))
        <div class="alert alert-success">
            {{session('status')}}<br>
            <a href="{{url('/parentdetails?infant_id='.session('infant')->id)}}" class="btn btn-info">Add Parent Details</a>
        </div>
    @endif
    <form method="post" action="{{url('/save-infant')}}">
        ENTER INFANTS DETAILS HERE<hr>
        {{csrf_field()}}
        ...
        <div class="row{{ $errors->has('sub_county') ? ' has-error' : '' }}">
            <label for="name" class="col-md-2 control-label">sub_county:</label>
        ...
        <h4>Health record of infant</h4>
        <div class="row{{ $errors->has('place_of_birth') ? ' has-error' : '' }}">
            <label for="name" class="col-md-2 control-label">place of birth:</label>
        ...
        <div class="row{{ $errors->has('special_needs') ? ' has-error' : '' }}">
            <label for="name" class="col-md-2 control-label">special_needs:</label>
